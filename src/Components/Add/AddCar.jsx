...
const AddCar = () => {
  ...
  return (
    <div className="pt-24 dark:text-white  dark:bg-black pb-7">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full p-2 border rounded dark:text-white  dark:bg-black"
              required
            />
          </div>
          <div>
          ...
          <div>
            <label className="block mb-1 font-bold dark:text-white  dark:bg-black">
          ...
          <div className="mt-4">
            <button
              type="submit"
              className="bg-primary border text-white px-4 py-2 rounded dark:text-white  dark:bg-black dark:border-white hover:bg-white hover:text-black "
            >
              Add Car
            </button>
          </div>
